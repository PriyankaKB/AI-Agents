...
API_KEY_NAME="news-demo-key-$(date +%s)"
...
# List of all agents + orchestrator
AGENTS=("mcp_drafting_app" "mcp_plagiarism_app" "mcp_seo_app" "mcp_publishing_app" "mcp_feedback_app" "orchestrator")
...
EOF
  ...
  echo "Successfully created .env for $AGENT_NAME at $ENV_FILE with PORT=$PORT"
done
