...
root_agent = LlmAgent(
    ...
    instruction=f"""
                ...
                1.  **BigQuery toolset:** Access seo-django, seo-django1, seo-django-logs, seo-django-robotstxt, seo-django-sitemaps in the mcp-blog dataset. Do not use any other datasets.
